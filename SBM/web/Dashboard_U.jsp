    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Dashboard_U.jsp" style="color:black">SBManageSVVV</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="pull-right"><a href="Login.html" class="js-right-sidebar" data-close="true"><div class="bg-yellow"><i class="material-icons">power_settings_new</i></div></a></li> 
                </ul>
            </div>
        </div>
    </nav>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:black;font-size: 20px"><%= session.getAttribute("name") %></div>
                    <div class="email" style="color:black"> <%= session.getAttribute("enroll") %> </div>
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="Login.html"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="legal">
                <div class="copyright" >
                     <a href="Dashboard_U.jsp" ><p style="color:black" >&copy; 2016 - 2017 SBManageSvvv.</p></a>
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-yellow hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text" style="text-transform: capitalize;text-align: center;font-size: 20px">Profile</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-yellow hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text" style="text-transform: capitalize;text-align: center;font-size: 20px">Feedback</div>
